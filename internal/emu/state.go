...
// clearHistory drops the scrollback for both the primary and alternate screens,
// leaving the visible screen intact — tmux's clear-history. Offsets reset with
// it, so the top of the screen becomes absolute line 0.
